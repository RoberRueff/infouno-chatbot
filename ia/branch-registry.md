...
> Panel de suscripción del tenant (`feature/tenant-billing-panel`) mergeado en `main` y rama borrada.
...
| Panel de billing del tenant: `Admin\TenantBillingPanel` (WP Admin, suscribir/cancelar premium) + `Billing\BillingServiceFactory` (wiring único, compartido con RestRouter) | v11 (sin cambio de schema) | ✅ (en `main`) |
