...
| `Infouno\SaaS\Admin` | `src/Admin/` | Paneles WP Admin: LeadDashboard, BotDashboard, BotWizard, OpportunityDashboard, BillingSettings (superadmin), **TenantBillingPanel** (tenant: ver plan + suscribir/cancelar premium) |
